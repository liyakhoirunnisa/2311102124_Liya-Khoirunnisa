...
int hitungLuasSegitiga_2124(int alas_2124, int tinggi_2124){
...
int main() {
    ...
    do { // Melakukan lopping menu pilihan bangun datar
    ...
    } while (pilihan_2124!=0); // Tetap melakukan looping selama pilihan tidak sama dengan 0
    return 0;    
